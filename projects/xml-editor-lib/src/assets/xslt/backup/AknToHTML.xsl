  ...
  <xsl:template match="/">
	...
	<xsl:template match="*">
	  ...
	  <xsl:variable name="inline">
		 ...
		 mmod, mref, neutralCitation, object,
		...
		<xsl:variable name="specialInline">
		 mod, 
		</xsl:variable>
	  ...
	  <xsl:variable name="num">
		...
		<xsl:when test="contains($specialInline,$ln)">
			<xsl:call-template name="element">
				<xsl:with-param name="pattern">inline</xsl:with-param>
				<xsl:with-param name="tag">div</xsl:with-param>
				<xsl:with-param name="inlineStyle">display:inline;</xsl:with-param>
			</xsl:call-template>
		</xsl:when>
		...
		<xsl:when test="contains($subflow,$ln)">
			<xsl:call-template name="element">
				...
				<xsl:with-param name="tag">div</xsl:with-param>
				<xsl:with-param name="inlineStyle">display:inline-block;</xsl:with-param>
			</xsl:call-template>
		</xsl:when>
...
<xsl:if test="$inlineStyle">
<xsl:attribute name="style"><xsl:value-of select="$inlineStyle"/></xsl:attribute>
</xsl:if>
<xsl:attribute name="pattern"><xsl:value-of select="$pattern"/></xsl:attribute>
<xsl:attribute name="name"><xsl:value-of select="local-name()"/></xsl:attribute>
<xsl:apply-templates select="@*"/>
